...
df = pd.read_csv(r"C:\Users\mpord\Documents\3IngSoft\2Cuatri\G4.Dedalus\material_dedalus\DatosSQUAD\resumen_lab_iniciales_conNombre.csv",encoding="utf-8")
...
for _, row in df.iterrows():
    ...
    context = (
        f"Paciente {row['PacienteID']} nombre {row['Nombre']}. "
